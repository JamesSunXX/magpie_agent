...
function withProjectContext(basePrompt: string, model: string, config: MagpieConfig): string {
...
function resolveTrdDefaults(config: MagpieConfig) {
...
function getOutputPaths(prdPath: string, sessionId: string, options: TrdOptions, config: MagpieConfig): OutputPaths {
...
function resolveReviewerIds(config: MagpieConfig, options: TrdOptions): string[] {
