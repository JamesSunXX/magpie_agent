...
export async function handleRepoReview(options: { path?: string; ignore?: string[]; reanalyze?: boolean; reviewers?: string; all?: boolean;[key: string]: unknown }, config: MagpieConfigV2, spinner: ReturnType<typeof ora>): Promise<void> {
